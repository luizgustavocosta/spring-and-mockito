...
class ReceiverTest {
    ...
    // Log message when input is a byte array
    @Test
    void test_log_message_when_input_is_byte_array(CapturedOutput capturedOutput) {
    ...
    // Log message when input is a String
    @Test
    void test_log_message_when_input_is_string(CapturedOutput capturedOutput) {
